---
title: Fractional CMO Pricing Benchmarks | Daniel Johnson
...
That is why [comparing a fractional CMO with a channel agency](/resources/fractional-cmo-vs-agency/) can be misleading. The agency may be doing valuable work, but the job is different. One executes a channel. The other decides what the system should do and how the channel fits inside it.
...
- [Fractional CMO cost (UK)](/resources/fractional-cmo-cost-uk/)
